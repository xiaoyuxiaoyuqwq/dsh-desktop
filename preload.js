...
const WHALE_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="100%" height="100%">
...
function createBadge(info) {
  ...
  Object.assign(badge.style, {
    ...
    height: '44px',
    borderRadius: '12px',
    background: 'linear-gradient(135deg,#1a2233,#0b0e17)',
  ...
  badge.addEventListener('click', () => {
    ...
    Object.assign(badgeText.style, {
      ...
      fontSize: '11px', color: '#8b93ab', whiteSpace: 'nowrap',
    });
...
function showUpToDate() {
  ...
  Object.assign(toast.style, {
    ...
    background: '#131a28', color: '#8b93ab', padding: '10px 16px',
    borderRadius: '8px', fontSize: '13px', boxShadow: '0 4px 16px rgba(0,0,0,.5)',
    border: '1px solid #2a3550', fontFamily: 'system-ui,sans-serif',
  });
