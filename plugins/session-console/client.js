  ...
  factory: (require) => {
    ...
    function Sidebar(props) {
      ...
      const toggleSkill = (name) => {
        ...
        call("toggle-skill", { name, sessionId }).then((r) => {
      ...
      const toggleTool = (name) => {
        const key = "t:" + name;
        setBusy((b) => { const n = Object.assign({}, b); n[key] = true; return n; });
        call("toggle-tool", { name, sessionId }).then((r) => {
      ...
      const showDetail = (name) => {
        call("skill-detail", { name, sessionId }).then((r) => {
    ...
    const name = "session-console-client";
    const inject = ["slots"];
